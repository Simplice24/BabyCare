                        ...
                        <div class="assignment-view">
                            <?= DetailView::widget([
                                ...
                                'attributes' => [
                                    ...
                                    [
                                        'attribute' => 'booking.starting_time',
                                        'label' => 'Starting Time',
                                    ],
                                    [
                                        'attribute' => 'booking.ending_time',
                                        'label' => 'Ending Time',
                                    ],
                                    [
                                        'attribute' => 'booking.email',
                                        'label' => 'Email',
                                    ],
                                    [
                                        'attribute' => 'booking.phone_number',
                                        'label' => 'Phone Number',
                                    ],
                                    [
                                        'attribute' => 'booking.address',
                                        'label' => 'Address',
                                    ],
                                    // 'created_at:datetime',
                                    // 'updated_at:datetime',
