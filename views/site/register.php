          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form action="<?= Yii::$app->urlManager->createUrl(['user/create']) ?>" method="POST">
                  <div class="mb-3">
                    <label for="exampleInputtext1" class="form-label">Names</label>
                    <input type="text" class="form-control" name="fullname" id="exampleInputtext1" aria-describedby="textHelp">
                  </div>
                  <div class="mb-3">
