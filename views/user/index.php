        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4 table-responsive" style="max-height: 500px;">
                <div class="mb-4">
                ...
                <ul class="timeline-widget mb-0 position-relative mb-n5">
                    <?php foreach ($recentRegistrations as $registration) : ?>
                        <li class="timeline-item d-flex position-relative overflow-hidden">
                            <div class="timeline-time text-dark flex-shrink-0 text-end"><?php echo $registration['created_at']; ?></div>
              ...
              <div class="col-lg-8 d-flex align-items-stretch">
                <div class="card w-100">
                      <div class="card-body p-4">
                        <h5 class="card-title fw-semibold mb-4">All Registrations</h5>
                        <!-- <table class="inputs">
                          <tbody><tr>
                              <td>Starting date:</td>
